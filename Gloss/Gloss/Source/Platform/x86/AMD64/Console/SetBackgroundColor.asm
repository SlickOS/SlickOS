...
.global AMD64_Console_SetBackgroundColor
AMD64_Console_SetBackgroundColor:
.global AMD64.Console.SetBackgroundColor
AMD64.Console.SetBackgroundColor:
    mov ax, di
    mov [AMD64.Console.ColorBackground], al
    ret
