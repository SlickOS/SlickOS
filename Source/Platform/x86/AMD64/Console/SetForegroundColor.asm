...
.global AMD64_Console_SetForegroundColor
AMD64_Console_SetForegroundColor:
.global AMD64.Console.SetForegroundColor
AMD64.Console.SetForegroundColor:
    mov ax, di
    mov [AMD64.Console.ColorForeground], al
    ret
