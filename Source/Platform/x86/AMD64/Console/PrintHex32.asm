...
.global AMD64_Console_PrintHex32
AMD64_Console_PrintHex32:
.global AMD64.Console.PrintHex32
AMD64.Console.PrintHex32:
    push rax
    push rbx
    push rcx
    push rdx
    ...
    AMD64.Console.PrintHex32.PrintDigit:
        mov rax, rsi
        mov rbx, 0x0F
        shl rbx, cl
        and rax, rbx
        ...
        sub cl, 0x04
        test dl, dl
        jnz AMD64.Console.PrintHex32.PrintDigit
